...
def main():
    ...
    parser.add_argument("--task", type=str, required=True, help="The task you want the AI to perform.")
    ...
    final_output = run_agent("Orchestrator (Gemini)", ORCHESTRATOR, orchestrator_system, claude_draft)
