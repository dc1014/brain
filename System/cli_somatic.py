...
def list_reflexes():
    ...
    console.print("[dim cyan]Reflex Arc Triggered: Querying Cerebellum...[/dim cyan]\n")
    res = list_engrams()
    console.print(res)
...
def flush():
    ...
    try:
        ...
        console.print("[yellow]Lymphatic routing unavailable, skipping flush.[/yellow]")
...
def sleep():
    ...
    console.print(
        "[dim cyan]Triggering Cerebellar consolidation of motor skills...[/dim cyan]"
    )
    compile()
