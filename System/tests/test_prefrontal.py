...
def test_prefrontal_swarm_execution(mocker):
    ...
    mocker.patch("System.runtime.run_agent", side_effect=mock_run_agent)
    ...
    try:
        execute_pipeline("Build a fullstack app", "SWARM", "STUDIO")
        success = True
