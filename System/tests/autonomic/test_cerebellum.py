def test_cerebellum_muscle_memory(monkeypatch, tmp_path):
    ...
    from System.neuroanatomy.autonomic.cerebellum import save_engram, list_engrams
    ...
    monkeypatch.setattr("System.neuroanatomy.autonomic.cerebellum.ROOT_DIR", root)
    monkeypatch.setattr(
        "System.neuroanatomy.autonomic.cerebellum.ENGRAM_DIR", engram_dir
    )
    monkeypatch.setattr(
        "System.neuroanatomy.autonomic.cerebellum.INDEX_FILE", index_file
    )
