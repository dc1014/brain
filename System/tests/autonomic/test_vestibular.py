from System.neuroanatomy.autonomic.vestibular import create_snapshot, restore_balance
...
def test_vestibular_atomic_rollback(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "System.neuroanatomy.autonomic.vestibular.VESTIBULAR_DIR",
        tmp_path / "Vestibular",
    )
    monkeypatch.setattr(
        "System.neuroanatomy.autonomic.vestibular.LEDGER_PATH",
        tmp_path / "Vestibular" / "ledger.json",
    )
