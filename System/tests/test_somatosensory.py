from System.organs.somatosensory import process_sensory_event
...
def test_somatosensory_cortex_local_reflex(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("System.organs.somatosensory.ROOT_DIR", tmp_path)

    printed_messages = []
    monkeypatch.setattr(
        "System.organs.somatosensory.console.print",
